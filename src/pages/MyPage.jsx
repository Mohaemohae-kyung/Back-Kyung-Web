...
export default function MyPage() {
  ...
  const [favoriteExperts, setFavoriteExperts] =
    useState([]);
  ...
  const loadFavorites = async () => {
    ...
    const res =
      await api.get('/api/mypage/favorites');
    ...
    >
      ...
      <div className="mypage-grid">
        ...
        <div className="stats-grid">
          ...
          <button
            type="button"
            className="card stat-card stat-button"
